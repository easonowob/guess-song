...
import { Music2, Play, Square, Pause, Monitor, User, Check, X, Send, LogOut, Maximize2, Infinity } from 'lucide-react'
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-12 gap-2">
                ...
                <button 
                  ...
                  className="col-span-2 py-3 bg-amber-600 hover:bg-amber-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-semibold rounded-xl text-base flex items-center justify-center gap-1"
                  title="播放 10 秒"
                >
                ...
                <button 
                  ...
                  disabled={!extractVideoId(videoId)} 
                  className="col-span-2 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-semibold rounded-xl text-base flex items-center justify-center gap-1"
                  title="完整播放 (無限制)"
                >
                ...
                {/* 3. 自訂長度群組 (佔 4/12) */}
                <div className="col-span-4 flex bg-white/10 rounded-xl p-1 gap-1">
                  <input 
                    type="number" 
                    min={1} 
                    max={120} 
                    ...
                    className="w-10 px-1 text-center bg-transparent text-white font-bold border-none outline-none focus:ring-0 text-sm"
                  />
